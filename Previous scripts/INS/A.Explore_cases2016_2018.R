...
png("Casos_INS/Scripts/outputs/Cases_years_scp1.png", width=8, height=4, 
    units="in", res=300)
plot.y <- plot(rabies.y, ylab ="Número de perros positivos",
...
box()
title(main="Casos de rabia canina en AQP", xlab="Años", ylab="Número de perros positivos")
