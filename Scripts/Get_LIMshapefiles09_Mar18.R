...
unique(LIM_prov_districts$NAME_3)
# [1] "Ancon"                   "Ate"                    
# [3] "Barranco"                "Breña"                  
# [5] "Carabayllo"              "Chaclacayo"             
# [7] "Chorrillos"              "Cieneguilla"            
# [9] "Comas"                   "El Agustino"            
# [11] "Independencia"           "Jesus Maria"            
# [13] "La Molina"               "La Victoria"            
# [15] "Lima"                    "Lince"                  
# [17] "Los Olivos"              "Lurigancho"             
# [19] "Lurin"                   "Magdalena del Mar"      
# [21] "Magdalena Vieja"         "Miraflores"             
# [23] "Pachacamac"              "Pucusana"               
# [25] "Puente Piedra"           "Punta Hermosa"          
# [27] "Punta Negra"             "Rimac"                  
# [29] "San Bartolo"             "San Borja"              
# [31] "San Isidro"              "San Juan de Lurigancho" 
# [33] "San Juan de Miraflores"  "San Luis"               
# [35] "San Martin de Porres"    "San Miguel"             
# [37] "Santa Anita"             "Santa Maria del Mar"    
# [39] "Santa Rosa"              "Santiago de Surco"      
# [41] "Surquillo"               "Villa El Salvador"      
# [43] "Villa Maria del Triunfo"

LIM_prov_districts$NAME_3 <- recode(LIM_prov_districts$NAME_3,  
                                   `Breña` = "Brena")
LIM_prov_districts_df <- LIM_prov_districts@data
writeOGR(LIM_prov_districts, dsn=".", layer="data/LIM_province_district_nosigns", 
          driver="ESRI Shapefile")
...
# Keep ONLY districts of infected Metropolitan Lima.
# Excluding:Pta Negra, Pta Hermosa, San Bartolo, Lurín, Cieneguilla, Ate,
# Chaclacayo, Luringancho
# 
LIM_LIM_prov <-  peru3[peru3$ID_1 %in% 15,]
LIM_LIM_prov_df <- LIM_prov@data
plot(LIM_LIM_prov) # OK
# writeOGR(LIM_LIM_prov, dsn=".", layer="data/LIM_LIM_prov", 
#          driver="ESRI Shapefile")
