...
# 
#Cambiar el nombre
png(filename="20200425_dailynews_COVID19.png", width=1100, height=600)
ggplot() + 
...
#    #       )+
#    labs(title="SARS-CoV-2 en PerÃº", y="Casos por regiÃ³n", 
#         x="Fecha", caption="Source :varios")+
#   bbc_style()
...
#   # theme(axis.text.x = element_text(angle=90),
#   #       )+
#   labs(title="SARS-CoV-2 en regiones", y="Casos por regiÃ³n", 
#        x="Fecha", caption="Source :varios")+
#   bbc_style()
# 
# p2<-ggplot()+
