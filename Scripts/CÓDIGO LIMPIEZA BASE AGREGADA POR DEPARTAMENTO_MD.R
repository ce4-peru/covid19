...
## Checar base
str(covid_dep) # 61 obs. of  31 variables
names(covid_dep)
...
covid_dep <- covid_dep[-61,-c(1,28:31)] #OJO
...
# write.csv(covid_dep2, "data/modificadas/covidPE_DEP_2020050_CA_clean.csv", row.names = FALSE)
