...
## Checar base
str(covid_dia) # 55 obs. of  14 variables
names(covid_dia)
...
# 1          1          1          1          1          1          1 
# 28/03/2020 28/04/2020 29/03/2020 29/04/2020 30/03/2020 31/03/2020 
# 1          1          1          1          1          1 
...
# write.csv(covid_dia, "data/modificadas/covidPE_PORdia_20200430_AL_clean.csv")
