...
## Checar base
str(covid_dia) # 63 obs. of  14 variables
names(covid_dia)
...
# 01/04/2020 01/05/2020 02/04/2020 02/05/2020 03/04/2020 03/05/2020 04/04/2020 
# 1          1          1          1          1          1          1 
...
# write.csv(covid_dia, "data/modificadas/covidPE_PORdia_20200508_AL_clean.csv")
